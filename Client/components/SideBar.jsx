...
function SideBar() {
  ...
  } else if (pathname === "/Dashboard/Fiches-pedagogiques") {
    activePage = "pédagogiques";
  } else if (pathname === "/Dashboard/Fiches-mensuelles") {
    activePage = "mensuelles";
  }
      ...
      <div className="flex flex-col flex-1 w-full justify-start p-4 gap-2">
        ...
        <Link
          ...
          className={`flex justify-start w-full py-3 px-4 items-center h-fit rounded-lg gap-3 ${
            isActive("Dashboard") ? "bg-primary" : "hover:bg-gray-100"
          }`}
        >
          <House
            size={18}
            strokeWidth={2.5}
            className={isActive("Dashboard") ? "text-white" : "text-Paragraph"}
          />
          <p
            className={`text-sm font-medium ${
              isActive("Dashboard") ? "text-white" : "text-Paragraph"
            }`}
          >
            Tableau de bord
          </p>
        ...
        <Link
          ...
          className={`flex justify-start w-full py-3 px-4 items-center h-fit rounded-lg gap-3 ${
            isActive("pédagogiques") ? "bg-primary" : "hover:bg-gray-100"
          }`}
        >
          <FileText
            size={18}
            strokeWidth={2.5}
            className={isActive("pédagogiques") ? "text-white" : "text-Paragraph"}
          />
          <p
            className={`text-sm font-medium ${
              isActive("pédagogiques") ? "text-white" : "text-Paragraph"
            }`}
          >
            Fiches pédagogiques
          </p>
        ...
        <Link
          ...
          className={`flex justify-start w-full py-3 px-4 items-center h-fit rounded-lg gap-3 ${
            isActive("mensuelles") ? "bg-primary" : "hover:bg-gray-100"
          }`}
        >
          <Calendar
            size={18}
            strokeWidth={2.5}
            className={isActive("mensuelles") ? "text-white" : "text-Paragraph"}
          />
          <p
            className={`text-sm font-medium ${
              isActive("mensuelles") ? "text-white" : "text-Paragraph"
            }`}
          >
            Fiches mensuelles
          </p>
